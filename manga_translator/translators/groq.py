...
class GroqTranslator(CommonTranslator):
    ...
    'When encountering names or honorifics (e.g., "-san"), do not assume or assign any gender—retain the original form or use gender-neutral language unless the source explicitly indicates a gender. '
    'Carefully analyze previous and current sentences to fully understand the context. '
    'This engine is designed for manga translation. '
    'When encountering culturally specific terms, honorifics, or proper names, retain them exactly as they appear in the source without alteration. '
    'Proper names must always be accurately romanized according to standard Hepburn romanization. '
    'For common phrases or expressions, prioritize their standard meanings unless the context clearly indicates a proper noun or unique usage. '
